...
async function optsAsync(projectDir, options) {
  ...
  if (options.devClient) {
    ...
    if (defaultTarget !== 'bare') {
      _log().default.warn(`\nOption ${_log().default.chalk.cyan('--dev-client')} can only be used in bare workflow apps. Run ${_log().default.chalk.cyan('expo eject')} and try again\n`);
